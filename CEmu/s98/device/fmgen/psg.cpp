...
void PSG::MakeEnvelopTable()
{
	...
	static uint8 table3[4] = {  0,  1, (uint8)255,  0 };
...
// ---------------------------------------------------------------------------
//	PCM f[^ðf«o·(2ch)
//	dest		PCM f[^ðWJ·é|C^
//	nsamples	WJ·é PCM ÌTv
//
