...
BEGIN_MESSAGE_MAP(CMpQueueDlg, CCustomBlurDialogBase)
	ON_BN_CLICKED(IDC_MPQ_UP, OnBnClickedUp)
	ON_BN_CLICKED(IDC_MPQ_DOWN, OnBnClickedDown)
	ON_BN_CLICKED(IDC_MPQ_REMOVE, OnBnClickedRemove)
	ON_BN_CLICKED(IDC_MPQ_CLEAR, OnBnClickedClear)
	ON_BN_CLICKED(IDC_MPQ_CLOSE, OnBnClickedClose)
	ON_WM_CLOSE()
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
