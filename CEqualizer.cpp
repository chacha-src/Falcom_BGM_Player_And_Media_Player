...
BOOL CEqualizer::OnInitDialog()
{
	...
	SetDlgItemText(IDC_STATIC_EQ_WET, LL14(L"ウェット", L"Wet", L"Mouillé", L"Bagnato", L"Húmedo", L"습함", L"湿", L"رطب", L"Мокрый", L"Wet", L"Molhado", L"Nat", L"Mokry", L"Islak"));
	SetDlgItemText(IDC_STATIC_EQ_ACOUSTIC, LL14(L"音響空間の音響モデル", L"Acoustic space model", L"Modèle d'espace acoustique", L"Modello spazio acustico", L"Modelo espacio acústico", L"음향 공간 모델", L"声学空间模型", L"نموذج الفضاء الصوتي", L"Модель акустического пространства", L"Akustisches Raummodell", L"Modelo espaço acústico", L"Akoestisch ruimtemodel", L"Model przestrzeni akustycznej", L"Akustik alan modeli"));
	SetDlgItemText(IDC_STATIC_EQ_SPECTRUM, LL14(L"スペクトル", L"Spectrum", L"Spectre", L"Spettro", L"Espectro", L"스펙트럼", L"频谱", L"الطيف", L"Спектр", L"Spektrum", L"Espectro", L"Spectrum", L"Widmo", L"Spektrum"));
	...
	SetDlgItemText(IDC_STATIC_EQ_BAND, LL14(L"帯", L"Band", L"Bande", L"Banda", L"Banda", L"밴드", L"频段", L"النطاق", L"Полоса", L"Band", L"Banda", L"Band", L"Pasmo", L"Bant"));
	SetDlgItemText(IDC_STATIC_EQ_LOUDNESS, LL14(L"響度", L"Loudness", L"Sonorité", L"Volume", L"Sonoridad", L"음량", L"响度", L"جهارة الصوت", L"Громкость", L"Lautheit", L"Sonoridade", L"Luidheid", L"Głośność", L"Ses yüksekliği"));
	SetDlgItemText(IDC_STATIC_EQ_WARMTH, LL14(L"温かさ", L"Warmth", L"Chaleur", L"Calore", L"Calidez", L"따뜻함", L"温暖", L"الدفء", L"Теплота", L"Wärme", L"Calor", L"Warmte", L"Ciepło", L"Sıcaklık"));
