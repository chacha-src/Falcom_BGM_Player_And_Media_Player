...
public:
	...
	CCustomStandardButton m_loopdevRefresh;
	...
	int  m_lastToggleFmMon;   // FM モニタ窓の凹み。savedata.fmmonwindow
...
protected:
	...
	afx_msg void OnVcApply();
	afx_msg void OnVcOpen();
