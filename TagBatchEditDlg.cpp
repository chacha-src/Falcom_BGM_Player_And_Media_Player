...
BEGIN_MESSAGE_MAP(CTagBatchEditDlg, CCustomBlurDialogBase)
	ON_BN_CLICKED(IDC_TB_APPLY, OnBnClickedApply)
	ON_BN_CLICKED(IDC_TB_CLOSE, OnBnClickedClose)
	ON_BN_CLICKED(IDC_TB_HELP, OnBnClickedHelp)
	ON_CONTROL_RANGE(EN_VSCROLL, IDC_TB_NAME_O, IDC_TB_ALB_E, OnEnVScroll)
	ON_CONTROL_RANGE(EN_HSCROLL, IDC_TB_NAME_O, IDC_TB_ALB_E, OnEnVScroll)
	ON_MESSAGE(TB_MSG_SYNC, OnPostSync)
	ON_WM_SIZE()
	ON_WM_DESTROY()
	ON_WM_CONTEXTMENU()
END_MESSAGE_MAP()
