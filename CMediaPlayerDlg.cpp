...
BOOL CMediaPlayerDlg::OnInitDialog()
{
	...
	if (m_botRace.GetSafeHwnd())
		addTip(m_botRace, LL14(L"Soft3D空中レースで遊びます。", L"Play Soft3D aerial race.", L"Jouer à la course aérienne Soft3D.", L"Gioca alla gara aerea Soft3D.", L"Jugar a la carrera aérea Soft3D.", L"Soft3D 공중 레이스로 놀기.", L"玩 Soft3D 空中竞速。", L"اللعب بسباق Soft3D الجوي.", L"Играть в воздушную гонку Soft3D.", L"Im Soft3D-Luftrennen spielen.", L"Jogar a corrida aérea Soft3D.", L"Speel Soft3D-luchtrace.", L"Graj w wyścig powietrzny Soft3D.", L"Soft3D hava yarışında oyna."));
