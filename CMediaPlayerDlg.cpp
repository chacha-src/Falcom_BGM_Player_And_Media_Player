...
BOOL CMediaPlayerDlg::OnInitDialog()
{
	...
	if (m_botRace.GetSafeHwnd())
		addTip(m_botRace, LL14(L"暇つぶしレース", L"Casual race", L"Course passe-temps", L"Gara per passare il tempo", L"Carrera para matar el tiempo", L"심심풀이 레이스", L"消遣竞速", L"سباق لتمضية الوقت", L"Гонка для досуга", L"Freizeit-Rennen", L"Corrida para passar o tempo", L"Race om de tijd te doden", L"Wyścig na zabicie czasu", L"Vakit geçirme yarışı"));
