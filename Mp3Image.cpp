...
*/		//if(plf!=0) 
	...
	if ((r.right - 100) * (xy) > x) {
		StretchBlt(dcc, 0, 0, (r.right - 100), r.bottom / (xy), hMem, 0, 0, x, y, SRCCOPY); //伸縮
	}
	else {
