...
BEGIN_MESSAGE_MAP(CSasamiFmScoreDlg, CCustomBlurDialogExBase)
	...
	ON_WM_CONTEXTMENU()
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_SASAMI_FM_OPEN, OnBnClickedOpen)
	ON_BN_CLICKED(IDC_SASAMI_FM_SAVE, OnBnClickedSave)
	ON_BN_CLICKED(IDC_SASAMI_FM_PLAY, OnBnClickedPlay)
	ON_BN_CLICKED(IDC_SASAMI_FM_EXPORT, OnBnClickedExport)
	ON_BN_CLICKED(IDC_SASAMI_FM_HELP, OnBnClickedHelp)
	ON_BN_CLICKED(IDC_SASAMI_FM_TEMPO, OnBnClickedTempo)
	ON_BN_CLICKED(IDC_SASAMI_FM_VOICEBTN, OnBnClickedVoice)
	ON_BN_CLICKED(IDC_SASAMI_FM_TOOL_PENCIL, OnBnClickedPencil)
	ON_BN_CLICKED(IDC_SASAMI_FM_TOOL_ERASE, OnBnClickedErase)
	ON_BN_CLICKED(IDC_SASAMI_FM_TOOL_SEL, OnBnClickedSel)
	ON_BN_CLICKED(IDC_SASAMI_FM_PAL, OnBnClickedPal)
	ON_BN_CLICKED(IDC_SASAMI_FM_PROP_UPD, OnBnClickedPropUpd)
	ON_BN_CLICKED(IDC_SASAMI_FM_MARK, OnBnClickedMark)
	ON_BN_CLICKED(IDC_SASAMI_FM_LOOPA, OnBnClickedLoopA)
	ON_BN_CLICKED(IDC_SASAMI_FM_LOOPB, OnBnClickedLoopB)
	ON_BN_CLICKED(IDC_SASAMI_FM_LOOPCLR, OnBnClickedLoopClr)
	ON_BN_CLICKED(IDC_SASAMI_FM_SHOWALL, OnBnClickedShowAll)
	ON_BN_CLICKED(IDC_SASAMI_FM_TEXT, OnBnClickedText)
	ON_BN_CLICKED(IDC_SASAMI_FM_ARR, OnBnClickedArr)
	ON_BN_CLICKED(IDC_SASAMI_FM_LAYOUT, OnBnClickedLayout)
	ON_BN_CLICKED(IDC_SASAMI_FM_ROLL, OnBnClickedRoll)
	ON_CBN_SELCHANGE(IDC_SASAMI_FM_INDEV, OnCbnMidiIn)
	ON_CBN_SELCHANGE(IDC_SASAMI_FM_INMODE, OnCbnMidiIn)
	ON_CBN_SELCHANGE(IDC_SASAMI_FM_CH, OnCbnSelchangeCh)
