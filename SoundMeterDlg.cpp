...
BEGIN_MESSAGE_MAP(CSoundMeterDlg, CCustomBlurDialogBase)
	ON_BN_CLICKED(IDC_SM_CLOSE, OnBnClickedClose)
	ON_BN_CLICKED(IDC_SM_HELP, OnBnClickedHelp)
	ON_CBN_SELCHANGE(IDC_SM_MIC, OnCbnSelchangeMic)
	ON_BN_CLICKED(IDC_SM_MIC_REFRESH, OnMicDevRefresh)
